...
- 精简发布包：排除依赖目录中的测试、文档与调试产物，发布包由 1570 个文件降至 80 个以内，规避 Marketplace 发布校验（Virus check）失败

## [1.11.0]

- 帖子图片支持右键"复制图片"：正文图片与大图查看页均可直接复制到系统剪贴板，保留 GIF 动图原始格式

## [1.10.1]

- 优化了分页组件，支持跳转和省略中间行 @[Zimuiii](https://github.com/Zimuiii)
